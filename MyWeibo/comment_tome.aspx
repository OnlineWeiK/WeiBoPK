<%@ Page Language="C#" AutoEventWireup="true" CodeFile="comment_tome.aspx.cs" Inherits="comment_tome" %>
...
<body>
	...
	<div id="header">
		<div id="header_wrap" class="row">
			...
			<ul id="page-links">
				...
				<li><a href="#" class="selected">评论</a></li>
	...
	<div id="content_wrap" class="row">
		...
		<div id="content_right_wrap">
			...
			<asp:Literal runat="server" ID="commentstomeHtml"></asp:Literal>
		</div>
	</div>
	</form>
</body>
