<%@ Page Language="C#" AutoEventWireup="true" CodeFile="weibopk.aspx.cs" Inherits="weibopk" %>
...
<body>
	...
	<div id="header">
		<div id="header_wrap" class="row">
			...
			<ul id="page-links">
				...
				<li><a href="http://127.0.0.1:50658/MyWeibo/relations.aspx">联系</a></li>
				<li><a href="http://127.0.0.1:50658/MyWeibo/comment_tome.aspx">评论</a></li>
                <li><a href="http://127.0.0.1:50658/MyWeibo/weibopk.aspx"class="selected">PK</a></li>
			</ul>
	...
	<div id="content_wrap" class="row">
		...
		<div id="content_right_wrap">
            ...
            <asp:Button ID="Button1" runat="server" CssClass="status-box-submit1" 
                Text="开始PK" onclick="Button1_Click" Font-Size="Medium" />  
                           <asp:Image ID="Image1" runat="server" ImageUrl="~/images/12.gif" />
                           <br />
			<asp:Literal runat="server" ID="myweibopkHtml"></asp:Literal>
		</div>
	</div>
	</form>
</body>
